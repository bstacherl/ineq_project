...
islands <- c("ES703", "ES704", "ES705", "ES706", "ES707", "ES708", "ES709", "ES531", "ES532", "ES533")
...
pcgdp15 <- rownames_to_column(pc_gdp, var = "NUTS_ID")
myvars <- c("NUTS_ID", "2015")
pcgdp15 <- pcgdp15[myvars]
names(pcgdp15)[2]<-paste("pcgdp_15")

shp <- merge(shp, pcgdp15, all.x = TRUE, all.y = TRUE, by.x = "NUTS_ID", by.y = "NUTS_ID") 
library(GISTools)
shades <- auto.shading(shp$pcgdp_15)
choropleth(shp, shp$pcgdp_15, shades)
